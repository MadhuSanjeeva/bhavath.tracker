...
@AllArgsConstructor
@Entity
@SequenceGenerator(name = "activation_packet_data_seq", sequenceName = "activation_packet_data_seq", allocationSize = 1)
@Table(name = "activation_packet_data")
public class ActivationPacketData implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "activation_packet_data_seq")
    private Long id;
