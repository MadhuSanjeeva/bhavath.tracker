...
@AllArgsConstructor
@Entity
@SequenceGenerator(name = "ebp_packet_data_seq", sequenceName = "ebp_packet_data_seq", allocationSize = 1)
@Table(name = "ebp_packet_data")
public class EBPPacketData implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ebp_packet_data_seq")
    private Long id;
