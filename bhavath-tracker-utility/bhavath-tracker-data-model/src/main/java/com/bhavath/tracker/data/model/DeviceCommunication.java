...
public class DeviceCommunication implements Serializable
{
	...
	@Column(name = "battery_percentage",columnDefinition="Decimal(10,2) default '0.00'")
	private Double batteryPercentage;
	
	@Column(name = "low_battery_threshold")
	private Double lowBatteryThreshold;
	
	@Column(name = "memory_percentage",columnDefinition="Decimal(10,2) default '0.00'")
	...
	@Column(name = "is_device_over_speed")
