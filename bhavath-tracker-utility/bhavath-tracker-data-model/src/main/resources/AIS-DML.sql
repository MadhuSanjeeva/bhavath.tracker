...
INSERT INTO public.user_details(id,user_name, email_id, mobile_number, first_name,last_name,is_enabled,password,last_password_reset_date,created_date)
	VALUES (1,'superadmin', 'superadmin@gmail.com', '9985996541', 'superadmin', 'superadmin',true,'$2a$08$lDnHPz7eUkSi6ao14Twuau08mzhWrL4kyZGGU5xfiGALO/Vxd5DOi',now(),now());
	
INSERT INTO public.user_details(id,user_name, email_id, mobile_number, first_name,last_name,is_enabled,password,last_password_reset_date,created_date)
	VALUES (2,'admin', 'admin@gmail.com', '9985996555', 'admin', 'admin',true,'$2a$08$lDnHPz7eUkSi6ao14Twuau08mzhWrL4kyZGGU5xfiGALO/Vxd5DOi',now(),now());
...
create or replace view device_details_view as
 select dd.id,
       dd.created_date,
       dd.imei_number,
	   dd.imsi_number,
 ...
 JOIN sim_details sd ON dd.id = sd.device_details_id;
 
  # =========================================================================================
   
 create or replace view route_deviation_view as
 select rd.id,
       rd.created_date,
       rd.deviation_time,
	   rd.lat_long,
	   ...
	   rd.trip_id
 from route_deviation rd
 JOIN trip_details td ON td.id = rd.trip_id;
